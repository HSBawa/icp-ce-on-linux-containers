...
resource "lxd_container" "icp_ce_master" {
  ...
  depends_on = ["lxd_container.icp_ce_proxy", "lxd_container.icp_ce_proxy", "lxd_container.icp_ce_mgmt","lxd_container.icp_ce_va", "lxd_container.icp_ce_worker_1", "lxd_container.icp_ce_worker_2", "lxd_container.icp_ce_worker_3"]
